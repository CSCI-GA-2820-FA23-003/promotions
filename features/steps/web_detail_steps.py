...
@then('I should see "{message}" in the title of detail page')
...
@then('I should see "{text}" in the "{element_name}" dropdown in detail page')
def step_impl(context, text, element_name):
    element_id = ID_PREFIX + element_name.lower().replace(" ", "_")
...
@then('the "{element_name}" field should be empty in detail page')
